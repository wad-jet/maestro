...
оценкой, **пропуски обязательного поиска** по достигнутым обязательным
точкам с причиной («memory layer не подключен» / «точка не достигнута» /
«пересмотр») и агрегаты эффективности.
