...
**пропуски обязательного поиска** по достигнутым обязательным точкам с причиной
(«memory layer не подключен» / «точка не достигнута» / «пересмотр»);
только агрегаты (SEC-4b).
