...
- [Выбор и замена модели эмбеддингов](how-to/choose-embedding-model.md) — критерии, рекомендуемые модели, настройка, переиндексация (пошагово), командный сценарий, проверка
