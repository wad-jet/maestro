...
export function createStorage({ type, options, modelId, dim, textSearchConfig }) {
  switch (type) {
    ...
    case "pgvector": return new PgVectorStorage({ pool: options.pool, table: options.table, dim, modelId, textSearchConfig });
    default:
