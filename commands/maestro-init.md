...
| `--auto-ai` / `-ai` | auto-ai | Максимальная автономность: ИИ сам принимает решения (маршрут, project-context, контентные вопросы — с доп. анализом), механика — ralph loop (Phase 2). Гейты 10/17 и чувствительные изменения — всегда вручную |
