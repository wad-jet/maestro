...
`SECURITY.md` — в той же фиче заводится автоматический тест-гард (отрицательный
тест, паттерн SEC-4b: «ни одна строка лога не содержит X»). Инвариант без
тест-гарда — незавершённая фича (не переходит к merge).
...
🟡 17. -- HITL GATE: pre-PR --
      ...
      **E2E-критерии приёмки (мягкий гейт):** если спека объявляет E2E-критерии
      ...
      — без молчаливого пропуска. Merge с непрогнанным E2E — решение HITL
      (варианты ниже), фиксируется в отчёте/регрессии.
      ВАРИАНТЫ:
